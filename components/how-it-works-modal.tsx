...
export function HowItWorksModal({ isOpen, onClose }: HowItWorksModalProps) {
  ...
  const steps = [
    ...
    {
      step: '03',
      title: 'Climb the Weekly Leaderboard',
      description: 'The most popular product memes rise to the top of the trending feed as users upvote and comment on your project.',
      icon: Trophy,
      badgeColor: 'bg-amber-400 text-zinc-950',
    },
    {
      step: '04',
      title: 'Win Badges & Viral Traffic',
      description: 'Top voted launches earn featured spotlights, verified badges, and real viral traffic for your startup.',
      icon: Award,
      badgeColor: 'bg-[#ffe600] text-zinc-950',
    },
  ];
